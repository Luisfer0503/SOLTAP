...
Route::middleware(['auth'])->group(function () {
    ...
    // Rutas para la asignación de costos de fallas por el ADMIN
    Route::get('/erp/costos-fallas', [ERPController::class, 'costosFallas'])->name('costosFallas');
    ...
    Route::post('/erp/guardar-costos-falla', [ERPController::class, 'guardarCostosFalla'])->name('guardarCostosFalla');
